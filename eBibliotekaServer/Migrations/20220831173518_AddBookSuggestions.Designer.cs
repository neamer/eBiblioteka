...
namespace eBibliotekaServer.Migrations
{
    ...
    [Migration("20220831173518_AddBookSuggestions")]
    partial class AddBookSuggestions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eBibliotekaServer.BookModule.Models.BookSeries", b =>
                {
            ...
            modelBuilder.Entity("eBibliotekaServer.BookModule.Models.Series", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eBibliotekaServer.LibraryModule.Models.BookSuggestion", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eBibliotekaServer.LibraryModule.Models.Library", b =>
                {
                    ...
                    b.Property<int?>("LibrarianRecommendationsID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LibrarianRecommendationsID");
            ...
            modelBuilder.Entity("eBibliotekaServer.LibraryModule.Models.Notification", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eBibliotekaServer.LocationModule.Models.Location", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eBibliotekaServer.BookModule.Models.BookSeries", b =>
                {
                    ...
                    b.HasOne("eBibliotekaServer.BookModule.Models.Series", "Series")
                        .WithMany("BookSeries")
            ...
            modelBuilder.Entity("eBibliotekaServer.LibraryModule.Models.Library", b =>
                {
                    ...
                    b.HasOne("eBibliotekaServer.BookModule.Models.Series", "LibrarianRecommendations")
                        .WithMany()
                        .HasForeignKey("LibrarianRecommendationsID");

                    b.HasOne("eBibliotekaServer.LocationModule.Models.Location", "Location")
                        .WithMany()
                    ...
                    b.Navigation("LibrarianRecommendations");
            ...
            modelBuilder.Entity("eBibliotekaServer.LibraryModule.Models.Notification", b =>
                {
                    b.HasOne("eBibliotekaServer.AuthModule.Models.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientID");

                    b.HasOne("eBibliotekaServer.AuthModule.Models.Librarian", "Sender")
                        .WithMany()
