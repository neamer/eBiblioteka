...
@Component({
  ...
  styleUrls: ['./my-account-user.component.css', '../my-account.component.css']
})
export class MyAccountUserComponent implements OnInit {
  ...
  constructor(private accountService: AccountService) {
    ...
    this.profileImgUploadOptions = {
      url: HttpConfig.EndPoints.user.profileImg,
  ...
  ngOnInit(): void {
    this.accountService.userGetAccount().subscribe((res) => {
      this.account = res;
